...
bot.onText(/\/help/, (msg) => {
    console.log(msg);
    bot.sendMessage(msg.chat.id, " Вы можете связаться со специалистом по телефону +7 (41531) 7-39-05/ +7 (41531) 7-16-52, или написать на нашу почту zapoved@kronoki.ru");
...
bot.on('message', (msg) => {
    ...
    if (msg.text.toString().toLowerCase() == groupe3) {
        bot.sendMessage(id,"Все об удобствах на кардонах!", {
            "reply_markup": {
                "keyboard": [
    ...
    if (msg.text.toString().toLowerCase() == gr1_task1) {
        ...
        bot.sendPhoto(id,"./img/comics1.png",{caption : "Наш комикс про подачу заявки!"} );
        ...
        bot.sendPhoto(id,"./img/comics2.png",{caption : "Про прием на 2022"} );
    }
